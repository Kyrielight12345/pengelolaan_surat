    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $lists) {
            ...
            if ($lists->tipe == 'Upload') {
                ...
                $cetak = '<a href="/Cetaksuratundangan?id_surat=' . $lists->id_surat . '" target="_blank" title="Cetak" class="btn btn-icon btn-sm btn-info"><i class="fas fa-print"></i></a>';
            }
    ...
    public function store()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            if ($tipeSurat == null) {
                ...
                $tipe = 'Upload';
            } else if ($tipeSurat == 'Surat_Keterangan_Siswa') {
                $input = $this->validate([
                    'tgl_surat' => 'required',
                    'nama_siswa'  => 'required',
                    'nisn' => 'required',
            ...
            } else if ($tipeSurat == 'Surat_Undangan') {
                $input = $this->validate([
                    'tgl_surat' => 'required',
                    'kepada' => 'required',
                    'hari' => 'required',
