<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <img src="../assets/img/stmik.png" alt="logo" width="120" class="shadow-light rounded-circle"><br>
            <a href="#">STMIK WIDYA PRATAMA</a>
            <hr>
            </hr>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="/admin/suratmasuk"><i class="fas fa-envelope"></i><span>Surat Masuk</span></a>
            </li>
            <li><a class="nav-link" href="/admin/suratkeluar"><i class="fas fa-envelope-open"></i> <span>Surat
                        Keluar</span></a></li>
            ...
            <li><a href="<?= base_url('/login/logout') ?>" class="dropdown-item has-icon text-danger"><i
            ...
            <li><a class="nav-link" href="/guru/suratmasuk"><i class="fas fa-envelope"></i><span>Surat Masuk</span></a>
            </li>
