            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3" width="175"><a href="#" class="btn btn-icon icon-left btn-primary"
                                onclick="edit(<?= $data['id'] ?>)"><i class="far fa-edit"></i>Edit </a></td>
                        <?php } ?>
                    </tr>
                </tbody>
            </table>
...
<div class="modal hide fade" id="ajaxModal" tabindex="-1" role="dialog" aria-labelledby="ajaxModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/dashboard/updateProfilSekolah') ?>" id="form-updateprofilsekolah"
                    method="POST">
            ...
            <div class="modal-footer bg-whitesmoke br">
                ...
                <button type="submit" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;Save
                    Record</button>
            </div>
            </form>
        </div>
